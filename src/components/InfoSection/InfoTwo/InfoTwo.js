            ...
            >
                ...
                <div className={classes.infoContent}>
                    <p className={classes.contentInitial}>
                        ...
                        <strong> concentration</strong> or you want to control
                        your time spent on performing a given activity.
                    </p>
                    <div className={classes.contentFull}>
                        <p>
                            This application is for you. Control the time and
                            make the time spent in concentration a pleasure.
                        </p>
                    </div>
                </div>
            </motion.div>
