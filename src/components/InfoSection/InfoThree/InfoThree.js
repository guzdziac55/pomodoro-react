            ...
            >
                ...
                <div className={classes.infoContent}>
                    <p className={classes.contentInitial}>
                        Your <strong> body</strong> will be able to work at high
                        speed for longer thanks to controlled breaks.
                    </p>
                    <div className={classes.contentFull}>
                        <p>
                            When you get to know your abilities, you can
                            determine the length of the working time in focus
                            yourself. Start with
                            <strong> 25 minutes</strong> - thats enough at the
                            beginning.
                        </p>
                    </div>
                </div>
